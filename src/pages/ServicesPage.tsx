...
import img1 from "../assets/bedroom10.jpeg";
import img2 from "../assets/bedroom16.jpeg";
import img3 from "../assets/bedroom8.png";
import img4 from "../assets/bedroom3.png";
import img5 from "../assets/bedroom9.png";
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-6 bg-white">
                ...
                {/* BUTTON */}
                <a
                  href="https://wa.me/919000052351?text=Hi%20I%20am%20interested%20in%20your%20interior%20services"
                  target="_blank"
                  className="mt-4 block text-center bg-red-500 text-white px-5 py-2 rounded-lg text-sm font-semibold hover:bg-red-600 transition"
                >
                  Enquire Now
                </a>
